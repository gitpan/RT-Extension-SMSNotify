...
#     INSTALLSITEARCH => q[/opt/rt4/local/man]
#     INSTALLSITELIB => q[/opt/rt4/local/plugins/RT-Extension-SMSNotify/lib]
#     INSTALLSITEMAN1DIR => q[/opt/rt4/local/man/man1]
#     INSTALLSITEMAN3DIR => q[/opt/rt4/local/man/man3]
#     LICENSE => q[perl]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/craig/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
INSTALLPRIVLIB = $(INSTALL_BASE)/lib/perl5
DESTINSTALLPRIVLIB = $(DESTDIR)$(INSTALLPRIVLIB)
INSTALLSITELIB = /opt/rt4/local/plugins/RT-Extension-SMSNotify/lib
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = $(INSTALL_BASE)/lib/perl5
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = /opt/rt4/local/plugins/RT-Extension-SMSNotify/lib
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /opt/rt4/local/man
...
INSTALLSITEMAN1DIR = /opt/rt4/local/man/man1
DESTINSTALLSITEMAN1DIR = $(DESTDIR)$(INSTALLSITEMAN1DIR)
INSTALLVENDORMAN1DIR = $(INSTALL_BASE)/man/man1
DESTINSTALLVENDORMAN1DIR = $(DESTDIR)$(INSTALLVENDORMAN1DIR)
INSTALLMAN3DIR = $(INSTALL_BASE)/man/man3
DESTINSTALLMAN3DIR = $(DESTDIR)$(INSTALLMAN3DIR)
INSTALLSITEMAN3DIR = /opt/rt4/local/man/man3
...
MAKE = make
FULLEXT = RT/Extension/SMSNotify
BASEEXT = SMSNotify
PARENT_NAME = RT::Extension
DLBASE = $(BASEEXT)
VERSION_FROM = lib/RT/Extension/SMSNotify.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Module::Install::RTx" VERSION="0.3" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="SMS::Send" VERSION="1.06" />' >> $(DISTNAME).ppd
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Module::Install::AutoManifest,0.003,Module::Install::ReadmeFromPod,0.20,Test::More,0.47,Carp,0,SMS::Send,1.06,Module::Install::RTx,0.30

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Module::Install::AutoManifest,0.003,Module::Install::ReadmeFromPod,0.20,Test::More,0.47,Carp,0,SMS::Send,1.06,Module::Install::RTx,0.30

listdeps ::
	@$(PERL) -le "print for @ARGV" 

listalldeps ::
	@$(PERL) -le "print for @ARGV" Module::Install::AutoManifest Module::Install::ReadmeFromPod Test::More Carp SMS::Send Module::Install::RTx
